  ...
  export default {
    ...
    methods: {
      ...
      mainLogic(queryObj){
        ...
        this.$router.push({ name: 'Search', params: { hotels: {queryObj: this.queryObj, searchBar: searchBarData }, avia: (this.$route.params.hasOwnProperty("avia") ? this.$route.params.avia : {}), show: "hotelTab"}});
